...
namespace UPM_IPS.CAFAMCMDGProyectoIPS2025
{
	...
	public partial class CAFAMCMDGProyectoIPS2025Diagram : DslDiagrams::Diagram
	{
		...
		protected override DslDiagrams::ShapeElement CreateChildShape(DslModeling::ModelElement element)
		{
			...
			if(element is global::UPM_IPS.CAFAMCMDGProyectoIPS2025.EntidadReferenciasRelacion)
			{
				global::UPM_IPS.CAFAMCMDGProyectoIPS2025.ConnectorER newShape = new global::UPM_IPS.CAFAMCMDGProyectoIPS2025.ConnectorER(this.Partition);
				return newShape;
			}
		...
		private global::UPM_IPS.CAFAMCMDGProyectoIPS2025.ConectorERConnectAction conectorERConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::UPM_IPS.CAFAMCMDGProyectoIPS2025.CAFAMCMDGProyectoIPS2025ToolboxHelper.ConectorERFilterString))
				{
					if (this.conectorERConnectAction == null)
					{
						this.conectorERConnectAction = new global::UPM_IPS.CAFAMCMDGProyectoIPS2025.ConectorERConnectAction(this);
						this.conectorERConnectAction.MouseActionDeactivated += new DslDiagrams::MouseAction.MouseActionDeactivatedEventHandler(OnConnectActionDeactivated);
					}
					action = this.conectorERConnectAction;
				} 
				else
				{
					action = null;
		...
		protected override void Dispose(bool disposing)
		{
			try
			{
				if(disposing)
				{
					if(this.conectorERConnectAction != null)
					{
						this.conectorERConnectAction.Dispose();
						this.conectorERConnectAction = null;
					}
				}
			}
			finally
...
namespace UPM_IPS.CAFAMCMDGProyectoIPS2025
{
		...
		[DslModeling::RuleOn(typeof(global::UPM_IPS.CAFAMCMDGProyectoIPS2025.EntidadReferenciasRelacion), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		...
		internal sealed class ConnectorRolePlayerChanged : DslModeling::RolePlayerChangeRule
		{
			...
			public override void RolePlayerChanged(DslModeling::RolePlayerChangedEventArgs e)
			{
				...
				foreach (DslDiagrams::PresentationViewsSubject connectorLink in connectorLinks)
				{
					...
					if (linkShape != null)
					{
						global::UPM_IPS.CAFAMCMDGProyectoIPS2025.CAFAMCMDGProyectoIPS2025Diagram diagram = linkShape.Diagram as global::UPM_IPS.CAFAMCMDGProyectoIPS2025.CAFAMCMDGProyectoIPS2025Diagram;
						if (diagram != null)
						{
