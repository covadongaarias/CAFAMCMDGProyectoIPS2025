...
namespace UPM_IPS.CAFAMCMDGProyectoIPS2025
{
	...
	/// </summary>
	public static partial class GeneradorEntidadReferenciasRelacion
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Entidad)
			{ 
				return true;
			}
			else
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Relacion)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Entidad)
				{
					if (candidateTarget is global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Relacion)
					{
						global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Entidad sourceEntidad = (global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Entidad)candidateSource;
						global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Relacion targetRelacion = (global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Relacion)candidateTarget;
						if(targetRelacion == null || sourceEntidad == null || global::UPM_IPS.CAFAMCMDGProyectoIPS2025.EntidadReferenciasRelacion.GetLinks(sourceEntidad, targetRelacion).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Entidad)
				{
					if (target is global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Relacion)
					{
						global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Entidad sourceAccepted = (global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Entidad)source;
						global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Relacion targetAccepted = (global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Relacion)target;
						DslModeling::ElementLink result = new global::UPM_IPS.CAFAMCMDGProyectoIPS2025.EntidadReferenciasRelacion(sourceAccepted, targetAccepted);
	...
	/// </summary>
	internal partial class ConectorERConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new ConectorERConnectAction for the given Diagram.
		/// </summary>
		public ConectorERConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the ConectorERConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new ConectorERConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class ConectorERConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the ConectorERConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected ConectorERConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder GeneradorEntidadReferenciasRelacion.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return GeneradorEntidadReferenciasRelacion.CanAcceptSource(sourceElement);
					}
					else
					{				
						return GeneradorEntidadReferenciasRelacion.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				GeneradorEntidadReferenciasRelacion.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class ConectorERConnectionType : ConectorERConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the ConectorERConnectionType with the given ConnectionBuilder.
			/// </summary>
			public ConectorERConnectionType() : base() {}
		}
	}
}
