...
namespace UPM_IPS.CAFAMCMDGProyectoIPS2025
{
	...
	/// </remarks>
	public partial class CAFAMCMDGProyectoIPS2025ToolboxHelper : CAFAMCMDGProyectoIPS2025ToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new CAFAMCMDGProyectoIPS2025ToolboxHelper.
		/// </summary>
		public CAFAMCMDGProyectoIPS2025ToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class CAFAMCMDGProyectoIPS2025ToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify CAFAMCMDGProyectoIPS2025 toolbox items.  
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Constructs a new CAFAMCMDGProyectoIPS2025ToolboxHelperBase.
		/// </summary>
		protected CAFAMCMDGProyectoIPS2025ToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.CAFAMCMDGProyectoIPS2025.CAFAMCMDGProyectoIPS2025DomainModel.SingletonResourceManager.GetString("CAFAMCMDGProyectoIPS2025ToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::UPM_IPS.CAFAMCMDGProyectoIPS2025.CAFAMCMDGProyectoIPS2025DomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "UPM_IPS.CAFAMCMDGProyectoIPS2025.EntidadToolboxItem":
					// Add Entidad shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.CAFAMCMDGProyectoIPS2025.EntidadToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Entidad.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "UPM_IPS.CAFAMCMDGProyectoIPS2025.RelacionToolboxItem":
					// Add Relacion shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.CAFAMCMDGProyectoIPS2025.RelacionToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::UPM_IPS.CAFAMCMDGProyectoIPS2025.Relacion.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "UPM_IPS.CAFAMCMDGProyectoIPS2025.AtributoClaveToolboxItem":
					// Add AtributoClave shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.CAFAMCMDGProyectoIPS2025.AtributoClaveToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::UPM_IPS.CAFAMCMDGProyectoIPS2025.AtributoClave.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "UPM_IPS.CAFAMCMDGProyectoIPS2025.AtributoEntidadToolboxItem":
					// Add AtributoEntidad shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.CAFAMCMDGProyectoIPS2025.AtributoEntidadToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::UPM_IPS.CAFAMCMDGProyectoIPS2025.AtributoEntidad.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "UPM_IPS.CAFAMCMDGProyectoIPS2025.AtributoRelacionToolboxItem":
					// Add AtributoRelacion shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.CAFAMCMDGProyectoIPS2025.AtributoRelacionToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::UPM_IPS.CAFAMCMDGProyectoIPS2025.CAFAMCMDGProyectoIPS2025DomainModel));
