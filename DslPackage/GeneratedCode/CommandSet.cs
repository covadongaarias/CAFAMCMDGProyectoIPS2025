...
namespace UPM_IPS.CAFAMCMDGProyectoIPS2025
{
	...
	/// </summary>
	internal partial class CAFAMCMDGProyectoIPS2025CommandSet : CAFAMCMDGProyectoIPS2025CommandSetBase
	{
		/// <summary>
		/// Constructs a new CAFAMCMDGProyectoIPS2025CommandSet.
		/// </summary>
		public CAFAMCMDGProyectoIPS2025CommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class CAFAMCMDGProyectoIPS2025CommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new CAFAMCMDGProyectoIPS2025CommandSetBase.
		/// </summary>
		protected CAFAMCMDGProyectoIPS2025CommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewCAFAMCMDGProyectoIPS2025ExplorerCommand,
				typeof(CAFAMCMDGProyectoIPS2025EditorFactory).GUID);
		...
		{
			CAFAMCMDGProyectoIPS2025ExplorerToolWindow explorer = this.CAFAMCMDGProyectoIPS2025ExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected CAFAMCMDGProyectoIPS2025DocData CurrentCAFAMCMDGProyectoIPS2025DocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as CAFAMCMDGProyectoIPS2025DocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected CAFAMCMDGProyectoIPS2025DocView CurrentCAFAMCMDGProyectoIPS2025DocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as CAFAMCMDGProyectoIPS2025DocView;
			}
		}
		...
		/// </summary>
		protected CAFAMCMDGProyectoIPS2025ExplorerToolWindow CAFAMCMDGProyectoIPS2025ExplorerToolWindow
		{
			get
			{
				CAFAMCMDGProyectoIPS2025ExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(CAFAMCMDGProyectoIPS2025ExplorerToolWindow), true) as CAFAMCMDGProyectoIPS2025ExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				CAFAMCMDGProyectoIPS2025ExplorerToolWindow explorerWindow = this.CAFAMCMDGProyectoIPS2025ExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class CAFAMCMDGProyectoIPS2025ClipboardCommandSet : CAFAMCMDGProyectoIPS2025ClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new CAFAMCMDGProyectoIPS2025ClipboardCommandSet.
		/// </summary>
		public CAFAMCMDGProyectoIPS2025ClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class CAFAMCMDGProyectoIPS2025ClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new CAFAMCMDGProyectoIPS2025ClipboardCommandSetBase.
		/// </summary>
		protected CAFAMCMDGProyectoIPS2025ClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
